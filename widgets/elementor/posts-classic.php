	...
	protected function register_controls() {
        ...
        $this->add_control(
			...
			array(
				...
				'default' => __( 'Classic Posts', 'coneblog-widgets' ),
				'condition' => [ 'show_widget_head' => 'yes' ]
			)
		);
        $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
                    '{{WRAPPER}} .coneblog-posts-classic .item-thumb img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;'
				],
			]
		);
		$this->add_control(
                        ...
                        <div class="list-item<?php echo ( esc_attr($layout == 1 || $layout == 2 ? ' item-1' : '') ) ?>">
                                ...
                                <a href="<?php the_permalink() ?>">
                                    <?php
                                        if(has_post_thumbnail()):
                                            ...
                                            echo '<img src="'.esc_url(CONEBLOG_ASSETS_PATH).'img/thumb-medium.png">';
                                        endif;
                                    ?>
                                </a>
                                <?php
                            ...
                            <div class="item-meta">
                                ...
                                if ( 'yes' === $settings['show_excerpt'] ) { ?>
                                    <p class="post-desc"><?php echo esc_textarea(($layout == 1 || $layout == 2 ? Helper::coneblog_list_excerpt(25) : Helper::coneblog_list_excerpt(50))) ?></p>
                                <?php } ?>
                    ...
                    <?php else: ?>
                        <div class="list-item">
                            ...
                            <div class="item-meta">
                                ...
                                <?php
                                if ( 'yes' === $settings['show_excerpt'] ) { ?>
                                    <p class="post-desc"><?php echo esc_textarea(( $layout == 1 || $layout == 2 ? Helper::coneblog_list_excerpt(15) : Helper::coneblog_list_excerpt(50) ))?></p>
                                <?php } ?>
